...
public class LogWriter {
	private static Boolean MYLOG_SWITCH = AppLogic.DEBUG; // 日志文件总开关
	...
	private static void log(String tag, String msg, char level) {
		if (MYLOG_SWITCH) {
			...
			if (MYLOG_WRITE_TO_FILE&&tag.equals(WebSocketClient.TAG))
	...
	private static void writeLogtoFile(String mylogtype, String tag, String text) {// 新建或打开日志文件
		...
		// FileEnvironment.getExternalStorageDirectory() + File.separator +
		// "DemoLog.txt";
		File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), needWriteFiel + MYLOGFILEName);
		try {
