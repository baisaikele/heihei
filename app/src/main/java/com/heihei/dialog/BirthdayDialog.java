...
import com.base.widget.wheel.OnWheelScrollListener;
import com.base.widget.wheel.WheelView;
import com.base.widget.wheel.adapters.AbstractWheelTextAdapter;
...
public class BirthdayDialog extends Dialog implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        first.setWheelBackground(R.color.full_transparent);
        ...
        second.setWheelBackground(R.color.full_transparent);
        ...
        third.setWheelBackground(R.color.full_transparent);
    ...
    private class CountryAdapter extends AbstractWheelTextAdapter {
        ...
        protected CountryAdapter(Context context) {
            super(context, R.layout.text_item, R.id.text_item_content);
        }
